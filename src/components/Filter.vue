...
<template>
  <div :class="props.embedded ? 'flex h-full w-full flex-col bg-white' : 'w-[409px] bg-white rounded-card border border-border flex flex-col max-h-[calc(100vh-300px)] overflow-hidden'">
    <div :class="props.embedded ? 'mb-4 flex items-center justify-between px-4 pt-4' : 'flex items-center justify-between p-4'">
    ...
    <div :class="props.embedded ? 'mt-6 flex-1 space-y-8 overflow-y-auto px-4 pb-4 pr-1' : 'mt-6 min-h-0 flex-1 space-y-8 overflow-y-auto px-4 pb-4 pr-3'">
      <section>
