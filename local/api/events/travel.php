...
const TRAVEL_SECTION_CODE = 'travel';
const TRAVEL_SECTION_NAME = 'Путешествия';
...
function findTravelSectionId(): ?int
{
...
function mapElementToTravelMarker(array $element): array
{
...
$sectionId = findTravelSectionId();
if ($sectionId === null) {
    respondJson(['error' => 'travel section not found'], 404);
}
...
while ($element = $elements->Fetch()) {
    $items[] = mapElementToTravelMarker($element);
}
